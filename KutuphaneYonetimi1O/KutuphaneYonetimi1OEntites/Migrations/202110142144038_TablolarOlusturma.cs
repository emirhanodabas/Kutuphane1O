namespace KutuphaneYonetimi1OEntites.Migrations
{
    ...
    public partial class TablolarOlusturma : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        UyeEmail = c.String(maxLength: 100, unicode: false),
                        DogumTarihi = c.DateTime(nullable: false, storeType: "date"),
                        Cinsiyet = c.String(maxLength: 1, fixedLength: true, unicode: false),
                        Telefon = c.String(maxLength: 15, fixedLength: true, unicode: false),
